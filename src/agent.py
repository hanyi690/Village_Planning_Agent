...
def _load_village_data(village_data: Union[str, Path]) -> str:
    """
    智能加载村庄数据：支持文件路径或直接文本

    Args:
        village_data: 文件路径或文本内容
...
def run_village_planning(
    ...
    Args:
        ...
        step_level: 逐步执行的暂停级别（layer/dimension/skill）
