# Village Boundary Proxy Verification Report v2

**Verification Time**: 2026-04-26 00:42:13
...
2. **Integrated Fusion**: IoU=0.4, Coverage=0.8601
3. **Morphological (Convex)**: IoU=0.3769, Coverage=0.8046
4. **Natural Boundary**: IoU=0.0415, Coverage=0.6721
...
- `output/boundary_proxy/comparison_chart_v2.png`
- `output/boundary_proxy/boundary_proxy_report_v2.md`