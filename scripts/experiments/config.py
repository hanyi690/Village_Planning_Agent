...
# 任务描述与约束（用于规划流程初始状态）
DEFAULT_TASK_DESCRIPTION = "制定金田村村庄总体规划（2022-2035年）"
...
3. 保护千年古檀林、古茶亭等历史资源
4. 基于现状常住人口500人的规模预测
5. 产业导向：特色南药、林下经济、客家文化
6. 报告格式采用法规式编号（第一章、第一条、（一）、（1）、表X-X）
"""
...
def check_kb_status(required_docs: List[str] = None) -> Dict[str, Any]:
    ...
    """
    try:
        from app.services.modules.rag.vector_store import get_parent_child_store
