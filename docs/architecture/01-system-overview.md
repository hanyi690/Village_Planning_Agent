...
| 文件 | 职责 |
|------|------|
| `frontend/src/features/planning/store/planningStore.ts` | Zustand 状态管理 |
| `frontend/src/features/planning/hooks/useSSE.ts` | SSE 连接 Hook |
...
- [05-frontend-state](./05-frontend-state.md) - 前端状态管理详解 [已实现]
