...
| 功能 | 文件路径 |
|------|----------|
| SSE管理 | `backend/app/services/sse.py` |
| 统一路由 | `backend/app/api/routes.py` |
| Checkpoint服务 | `backend/app/services/checkpoint.py` |
...
- [05-frontend-state](./05-frontend-state.md) - 前端SSE处理 [搁置]
