...
ToolResult 定义已移至 protocol.py，统一所有工具的返回值格式。
"""
...
from .protocol import ToolResult  # Unified ToolResult
...
# ==========================================
# NormalizedToolResult（dimension_node使用）
# ==========================================
...
__all__ = [
    # ToolResult from protocol.py (re-exported)
    "ToolResult",
    # NormalizedToolResult for dimension_node
    "ResultDataType",
    "NormalizedToolResult",
