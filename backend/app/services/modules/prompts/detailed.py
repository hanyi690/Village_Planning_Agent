...
【整体风貌定位与景观格局】
[用1-2段话描述村庄总体风貌设计主题，包括宏观的山水田园格局、核心景观特色]

【建筑风貌控制导则】
| 控制要素 | 控制内容与要求 |
| 建筑风格 | [详细描述建筑的屋顶形式、山墙造型、装饰构件等风格要求] |
| 建筑色彩 | [详细描述墙身、屋顶、门窗等的推荐色系和材质，可给出RGB参考值] |
| 建筑高度与体量 | [描述不同功能区和位置的高度、层数控制要求] |
| 材质指引 | [推荐乡土材料（如青砖、石材、木材）的使用部位和方法，并明确禁用材料] |

【核心景观节点设计指引】（可选，如果有的话）
| 节点名称 | 位置 | 设计要点与意向 |

【人居环境整治指引】
对环境整治的要点进行自然段落的叙述，避免使用待办事项清单格式，重点是提出不同区域环境整治的原则和标准。
