...
from app.utils.event_factory import (
...
class PlanningRuntimeService:
    ...
    def build_initial_state(
        ...
        state = {
            ...
            "human_feedback": "",
            "step_mode": step_mode,
            "pause_after_step": False,  # 新架构：暂停标志
            "previous_layer": 0,  # 新架构：刚完成的层级
            "gis_analysis_results": {},  # 新架构：GIS分析结果
            "metadata": {
                "published_layers": [],
                "version": 0,
    ...
    async def start_session(
        ...
        Args:
            ...
            image_ids: Optional list of image IDs for multimodal analysis
